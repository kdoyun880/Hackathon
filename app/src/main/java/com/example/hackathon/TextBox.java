...
public class TextBox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent logToText = getIntent();
        nameText.setText(logToText.getStringExtra("nameText").toString());
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent textToMain = new Intent(getApplicationContext(), MainActivity.class);
                textToMain.putExtra("strings",category);
                startActivity(textToMain);
